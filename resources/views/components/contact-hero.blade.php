<section class="bg-white">
    <div class="grid max-w-screen-xl px-4 pt-12 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">Máte na nás otázku?</h1>
            ...
            <form method="get" action="{{route('search')}}" class="my-auto">
                <div class="flex">
                    <div class="relative w-full">
                        ...
                        <button type="submit" class="absolute top-0 right-0 h-full p-2.5 text-sm font-medium text-white bg-primary rounded-r-lg hover:bg-secondary">
