        ...
        <div class="w-full dark:bg-gray-800 dark:border-gray-700 flex flex-row">
        	...
        	<div class="w-1/2 basis-1/3 p-6 space-y-4 md:space-y-6 sm:p-8">
        		...
        		<form method="post" action="{{ route('profile.destroy') }}" class="mt-6 space-y-6">
        			...
        			<button type="submit" class="mt-5 block w-full rounded-md bg-red-800 hover:bg-red-700 px-3 py-3 text-center text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Zrušiť účet</button>
        		</form>
        	</div>
        </div>
    </div>
