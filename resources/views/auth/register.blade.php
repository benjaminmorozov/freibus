          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form method="POST" action="{{ route('register') }}" class="space-y-4 md:space-y-6">
                @csrf
                  ...
                  <button type="submit" class="w-full bg-indigo-800 text-white font-bold text-sm uppercase rounded hover:bg-blue-700 flex items-center justify-center px-2 py-3 mt-4">Create an account</button>
