...
<body class="bg-white font-family-karla">
    ...
    <div class="text-center py-4 lg:px-4" style="padding-bottom: 0 !important">
        <div class="p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
            <span class="flex rounded-full bg-indigo-500 uppercase px-2 py-1 text-xs font-bold mr-3">Ponuka práce</span>
    ...
    <footer class="w-full border-t bg-white pb-12">
        <div class="relative w-full grid grid grid-flow-col auto-cols-max invisible md:visible md:pb-12">
            {{ $carouselview }}
        </div>
