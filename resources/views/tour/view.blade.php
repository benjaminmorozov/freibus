<x-app-layout>
    <div class="bg-white">
        <div class="pt-6">
            ...
            <!-- Image gallery -->
            <div class="mx-auto mt-6 max-w-7xl grid grid-auto-rows grid-flow-col gap-4 gap-x-8 px-8 pb-2 h-96"> <!-- max-h-96 would be used but safari and firefox are broken --->
